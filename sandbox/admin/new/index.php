        ...
        <div class="d-flex flex-column mt-5">
          <form action="" method="post">
            <div class="d-flex flex-column form-floating">
              <textarea placeholder="Intitulé" name="intitule" id="intitule" class="form-control" style="height: 70px;" maxlength="255"></textarea>
            ...
            <div class="d-flex flex-column mt-5">
              ...
              <div class="d-flex flex-row flex-wrap">
                <div class="d-flex flex-row m-2 align-items-center">
                  ...
                  <input id="answ1" type="text" required autocomplete="off" maxlength="100">
                </div>
                <div class="d-flex flex-row m-2 align-items-center">
                  <label for="answ2" class="me-3">Réponse 2 :</label>
                  <input id="answ2" type="text" required autocomplete="off" maxlength="100">
                </div>
                <div class="d-flex flex-row m-2 align-items-center">
                  <label for="answ3" class="me-3">Réponse 3 :</label>
                  <input id="answ3" type="text" required autocomplete="off" maxlength="100">
                  <button type="button" class="btn link-danger"><i class="fa-solid fa-trash"></i></button>
                </div>
                <div class="d-flex flex-row m-2 ms-4">
                  <a href="" class="fs-5">+ Ajouter une réponse</a>
                </div>
              </div>
            </div>
            <div class="d-flex flex-column mt-5">
